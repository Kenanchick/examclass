...
На этапе 3 эта базовая проекция заменена многомерным расчётом скорости, стабильности, повторения и расширенных статусов. Актуальная формула описана в `stage-3-knowledge-profile.md`.
