...
function DifficultyDots({ difficulty }: { difficulty: number }) {
  return (
    <div aria-label={`Сложность: ${difficulty} из 3`} className="flex gap-1.5">
        ...
        return (
          <span
            className={`size-2.5 rounded-full ${
              isActive
                ? "bg-brand animate-[twinkle_2.6s_ease-in-out_infinite]"
                : "bg-line"
            }`}
            key={index}
            style={
    ...
    <StudentLayout>
      <main className="min-w-0 p-4 sm:p-7 lg:p-8">
        <div className="mx-auto max-w-[1320px]">
          ...
          <section className="relative mt-5 overflow-hidden rounded-3xl border border-[#c6ddf5] bg-[#eef6ff] px-6 py-7 sm:px-8">
            ...
            <article className="overflow-hidden rounded-3xl border border-line bg-white shadow-[0_16px_35px_rgba(15,43,76,0.06)]">
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-line px-6 py-5 sm:px-8">
                ...
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-line bg-white px-3 py-2 text-xs font-bold text-brand transition hover:border-brand/35 hover:bg-panel"
              ...
              <div className="px-6 py-7 sm:px-8 sm:py-9">
                <p className="max-w-4xl text-lg leading-8 text-ink sm:text-xl">
                  {task.statement}
                </p>
                ...
                <div className="mt-9 rounded-2xl border border-line bg-panel/60 p-4 sm:p-5">
                  ...
                  <div className="mt-3 flex flex-col gap-3 sm:flex-row">
                    <input
                      className="min-w-0 flex-1 rounded-xl border border-line bg-white px-4 py-3 text-base text-ink outline-none transition placeholder:text-muted focus:border-brand focus:ring-4 focus:ring-brand/10"
                      id="answer"
                      onChange={(event) => {
                    ...
                    />
                    <button
                      className="cursor-pointer rounded-xl bg-brand px-6 py-3 text-sm font-bold text-white transition hover:bg-brand/90 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <button
                  ...
                  className="mt-5 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-brand/25 bg-brand/5 px-4 py-3 text-sm font-bold text-brand transition hover:bg-brand/10"
                  ...
                  <div className="min-h-0 overflow-hidden">
                    <div className="relative overflow-hidden rounded-2xl border border-[#c6ddf5] bg-[#eef6ff] p-5 pr-5 sm:p-6 sm:pr-40">
                      <div className="relative z-10">
                        ...
                        <p className="mt-3 max-w-2xl text-[15px] leading-7 text-ink">
