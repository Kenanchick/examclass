      ...
      <header className="border-b border-line bg-white">
        <div className="mx-auto flex h-24 max-w-[1600px] items-center justify-between gap-6 px-5 sm:px-8">
          <div className="flex items-center gap-2">
            <button
              className="grid size-10 place-items-center rounded-xl text-muted transition hover:bg-panel hover:text-ink lg:hidden"
          ...
          <label className="hidden w-full max-w-[490px] items-center gap-3 rounded-xl border border-line bg-white px-4 py-3 md:flex">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="grid size-10 place-items-center rounded-full text-muted transition hover:bg-panel hover:text-ink"
              type="button"
            >
            ...
            <button
              className="flex items-center gap-2 rounded-xl px-1 py-1 text-sm font-semibold text-ink transition hover:bg-panel"
              type="button"
            >
